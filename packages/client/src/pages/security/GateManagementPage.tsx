  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="inline-flex rounded-2xl bg-surface-container p-1 w-full max-w-sm">
            ...
            {activeVisitors.length === 0 ? (
              ...
              <div className="space-y-3">
                {activeVisitors.map((visitor) => (
                  <div key={visitor.id} className="rounded-2xl border border-outline-variant/20 p-4 bg-surface-container/40 space-y-2">
