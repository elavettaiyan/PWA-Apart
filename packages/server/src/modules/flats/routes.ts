...
import {
  buildLegacyVehicleFields,
  buildMyFlatInclude,
  deriveLegacyVehicleNumbers,
  findActiveOwnerMappingForUser,
  findUserByEmailInsensitive,
  FLAT_FEATURES,
  getFlatLimitStatus,
  getLinkedMembershipRole,
  getOutstandingFlatDue,
  getRequestSocietyId,
  getResidentVehiclesFromLegacyFields,
  INDIAN_MOBILE_REGEX,
  normalizeIndianMobileNumber,
  normalizeOptionalResidentCount,
  normalizeRegistrationValue,
  normalizeResidentTextValue,
  parseJsonBodyField,
  PARKING_TYPES,
  residentVehicleSelect,
  sanitizeFlatFeatures,
  sanitizeResidentVehicles,
  shouldDeleteResidentMembership,
  VEHICLE_TYPES,
} from './service';
